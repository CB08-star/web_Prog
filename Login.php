...
{error_reporting(1);
	...
	$que1=mysqli_query($con,"select * from users where Email='$user' and Password='$pass'");
	$count1=mysqli_num_rows($que1);
	
	if($count1>0)
	{
		session_start();
		$_SESSION['tempsuser']=$user;
		...
		if($count2>0)
		{
			...
			if($count3>0)
			{
				$que4=mysqli_query($con,"select * from user_secret_quotes where user_id=$userid");
				...
				if($que2=="" && $ans2=="")
				{
					header("location:s_files/s_step/s_step3/Secret_Question2.php");
				}
				else
				{
					...
					header("location:s_files/s_home/Home.php");
				}
				
			}
			else
			{
				header("location:s_files/s_step/s_step2/Secret_Question1.php");
			}
		}
		else
		{
			...
			if($Gender=="Male")
			{
				header("location:s_files/s_step/s_step1/Step1_Male.php");
			}
			else
			{
				header("location:s_files/s_step/s_step1/Step1_Female.php");
			}
		}
	}
	else
