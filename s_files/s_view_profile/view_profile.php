...
<?php
	$que_post_bg1=mysqli_query($con,"select * from user_post where user_id=$v_user_id");
...
<table cellspacing="0">
<?php
	$que_post=mysqli_query($con,"select * from user_post where user_id=$v_user_id and priority='Public' order by post_id desc");
