...
<?php
	if(isset($_POST['txt']))
	{
		...
		mysqli_query($con,"insert into user_post(user_id,post_txt,post_time,priority) values('$userid','$txt','$post_time','$priority');");
	}
	...
	if(isset($_POST['file']) && ($_POST['file']=='post'))
	{
		...
		if($gender=="Male")
		{
			$path = "../../s_users/Male/".$user."/Post/";
		}
		else
		{
			$path = "../../s_users/Female/".$user."/Post/";
		}
		...
		if($gender=="Male")
		{
			move_uploaded_file($img_tmp_name,"../../s_users/Male/".$user."/Post/".$prod_img_path);
		}
		else
		{
			move_uploaded_file($img_tmp_name,"../../s_users/Female/".$user."/Post/".$prod_img_path);
		}
    	mysqli_query($con,"insert into user_post(user_id,post_txt,post_pic,post_time,priority) values('$userid','$txt','$img_name','$post_time','$priority');");
	}
...
<?php
	$que_post_img=mysqli_query($con,"select * from user_post where user_id=$userid and post_pic!='' order by post_id desc");
	$photos_count=mysqli_num_rows($que_post_img);
	$photos_count=$photos_count+$count1+1;
?>

<div style="position:absolute;left:30.5%; top:54%; font-weight:bold; z-index:1;">  Publications  </div>
...
<?php
	$que_post_bg1=mysqli_query($con,"select * from user_post where user_id=$userid");
...
<table cellspacing="0">
<?php
	$que_post=mysqli_query($con,"select * from user_post where user_id=$userid order by post_id desc");
...
?>
	<tr>
		...
		<tr>
		<td width="5%" style="padding-left:10;" rowspan="2"> <img src="../../s_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
		<td > </td>
		<td> </td>
		<td> </td>
	</tr>
...
<?php 
	...
	<tr>
		<td>   </td>
		<td colspan="3"><img src="../../s_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Post/<?php echo $post_img; ?>" width="400" height="400"> </td>
		<td> </td>
		<td> </td>
	</tr>
	<?php
	...
	<tr>
		<td>   </td>
		<td  bgcolor="#EDEFF4" style="width:9;" colspan="3"><img src="img/like.PNG"><span style="color:#6D84C4;"><?php echo $count_like; ?></span> liked this. </td>
		<td> </td>
		<td> </td>
	</tr>
	<tr>
...
?>
	...
	<tr>
		<td> </td>
		<td width="4%" bgcolor="#EDEFF4" style="padding-left:12;" rowspan="2">  <img src="../../s_users/<?php echo $user_gender1; ?>/<?php echo $user_Email1; ?>/Profile/<?php echo $user_pic1; ?>" height="40" width="47">    </td>
...
<tr>
	<td> </td>
	<td width="4%" style="padding-left:17;" bgcolor="#EDEFF4" rowspan="2">  <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:33; width:33;">    </td>
...
<!-- About bg-->
	...
	<div style="position:absolute; left:22%; top:66%;"> <a href="about.php" style="color:#6A7480;text-decoration:none;font-size:17px; font-weight:bold;"> Account </a> </div>
...
<?php
	$user_info_query=mysqli_query($con,"select * from user_info where user_id=$userid");
...
<!-- Photos bg-->
	...
	<div style="position:absolute; left:22%; top:101%;"> <a href="photos.php" style="color:#6A7480;text-decoration:none;font-size:17px; font-weight:bold;"> Photos </a> </div>
...
?>
	<div style="position:absolute; left:15.5%; top:108%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img_array[0] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:108%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[1] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:108%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[2] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:125%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[3] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:125%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[4] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:125%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[5] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:142%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[6] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:142%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[7] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:142%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[8] ?>" height="90" width="78">  </div>
