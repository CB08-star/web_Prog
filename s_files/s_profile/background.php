...
if(isset($_POST['file']) && ($_POST['file']=='Upload'))
{
		if($gender=="Male")
		{
			$path = "../../s_users/Male/".$user."/Profile/";
		}
		else
		{
			$path = "../../s_users/Female/".$user."/Profile/";
		}
		...
		if($gender=="Male")
		{
			move_uploaded_file($img_tmp_name,"../../s_users/Male/".$user."/Profile/".$prod_img_path);
		}
		else
		{
			move_uploaded_file($img_tmp_name,"../../s_users/Female/".$user."/Profile/".$prod_img_path);
		}
    	mysqli_query($con,"update user_profile_pic set image='$img_name' where user_id=$userid;");
...
if(isset($_POST['file1']) && ($_POST['file1']=='Upload'))
{
		if($gender=="Male")
		{
			$path = "../../s_users/Male/".$user."/Cover/";
		}
		else
		{
			$path = "../../s_users/Female/".$user."/Cover/";
		}
		...
		if($gender=="Male")
		{
			move_uploaded_file($img_tmp_name,"../../s_users/Male/".$user."/Cover/".$prod_img_path);
		}
		else
		{
			move_uploaded_file($img_tmp_name,"../../s_users/Female/".$user."/Cover/".$prod_img_path);
		}
    	mysqli_query($con,"insert into user_cover_pic(user_id,image) values('$userid','$img_name');");
		header("location:Profile.php");
}
...
if(isset($_POST['file2']) && ($_POST['file2']=='Upload'))
{
		...
		mysqli_query($con,"update user_cover_pic set image='$img_name' where user_id=$userid;");
		header("location:Profile.php");
}
?>
<html>
...
<!--Head background-->
<div style="position:fixed;left:0;top:0; height:6.2%; width:100%; z-index:2; background:#071e22">   </div>
<!--Head s text-->
<div style="position:fixed;left:4.05%;top:0.8%;font-size:25;font-weight:900; z-index:3;"> <a href="../s_home/Home.php" style="color:#FFFFFF; text-decoration:none;" onMouseOver="on_head_s_text()" onMouseOut="out_head_s_text()"> <font face="mysFont"> SOLARIS </font> </a> </div>
<!--Head s text background-->
<div style="position:fixed;left:4%;top:1%; height:5%; width:8%; z-index:2; background:#4A63A5; display:none;" id="head_s_text_backgraound">   </div>

<div style="position:fixed; left:12.5%; top:1.6%; z-index:2;"> <a href="../s_home/Group_Message.php"> <img src="background_file/background_icons/messages.jpg"> </a> </div>
...
<form name="s_search" action="../s_home/Search_Display_submit.php" method="get" onSubmit="return bcheck()">
...
<div style="position:fixed; left:71.8%; top:0.6%; z-index:2;">
	...
	<tr id="hedarname2">
		...
		<td style="padding-left:7;" id="head_img" onMouseOver="head_pro_pic_over()" onMouseOut="head_pro_pic_out()"> <a href="Profile.php">  <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:27; width:25;"> </a> </td>
		...
		<td id="head_home_bg" onMouseOver="head_home_over()" onMouseOut="head_home_out()"> <a href="../s_home/Home.php" id="head_home_font" style="color:#DEDEEF; font-size:12; font-weight:900;font-family:lucida Bright; text-decoration:none;"> &nbsp; Home &nbsp; </a> </td>
        <td style="color:#DEDEEF;">|</td>
	</tr>
	</table>
</div>
...
<div style="position:fixed; left:88.2%; top:15%; z-index:3;"><a href="photos.php" style="text-decoration:none; color:#000;" id="head_photos" onMouseOver="head_photos_over()" onMouseOut="head_photos_out()"><h4>Photos</h4></a></div>
	...
	<div style="position:fixed; left:85.8%; top:23%; z-index:3;"> <a href="../s_home/Settings.php"> <img src="img/settings2.png" height="25" width="23" onMouseOver="head_settings_over()" onMouseOut="head_settings_out()"> </a> </div>
<div style="position:fixed; left:88.2%; top:20%; z-index:3;"><a href="../s_home/Settings.php" style="text-decoration:none; color:#000;" id="head_settings" onMouseOver="head_settings_over()" onMouseOut="head_settings_out()"><h4> Account Settings </h4></a></div>

<div style="position:fixed; left:86.1%; top:27.5%; z-index:3;"> <a href="../s_home/feedback.php"> <img src="background_file/background_icons/icon-feedback.png" height="20" width="20" onMouseOver="head_feedback_over()" onMouseOut="head_feedback_out()"> </a> </div>
<div style="position:fixed; left:88.3%; top:24.5%; z-index:3;"><a href="../s_home/feedback.php" style="text-decoration:none; color:#000;" id="head_feedback" onMouseOver="head_feedback_over()" onMouseOut="head_feedback_out()"><h4> Feedback </h4></a></div>
...
<!--cover img-->
<?php 
	$query3=mysqli_query($con,"select * from user_cover_pic where user_id=$userid");
	$rec3=mysqli_fetch_array($query3);
	$cover_img=$rec3[2];
	
	$que_post_bg=mysqli_query($con,"select * from user_post where user_id=$userid");
	$count_bg=mysqli_num_rows($que_post_bg);
	$count_bg=$count_bg+1;
?>
<div style="position:absolute; left:15.11%; top:6%;"> <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Cover/<?php echo $cover_img; ?>" height="279" width="943" onMouseOver="dis_cover_pic_edit();" onMouseOut="out_cover_pic_edit();" onClick="open_cover_photo()"> </div>
...
<img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Cover/<?php echo $cover_img; ?>" style="height:500; width:800; ">
</div>
</div>
...
<div style="position:absolute; left:16.5%; top:33%; z-index:1;">
	<table border="0">
	<tr>
		<td>  <img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:150; width:150;" onMouseOver="dis_pro_pic_edit();" onMouseOut="out_pro_pic_edit();" onClick="open_profile_photo()">  </td>
		<td>  &nbsp; &nbsp; <a href="../s_profile/Profile.php" onMouseOver="left_name_over()" onMouseOut="left_name_out()" style="color:#FFFFFF; font-size:16; font-weight:900;font-family:lucida Bright; text-transform:capitalize; text-decoration:none; background-color:#000000;" id="left_name">   <?php echo $name; ?>  </a> </td>
	</tr>
	</table>
</div>
...
<div style="position:fixed; background:#FFF; left:17%; top:5%; height:90%; width:65.5%; z-index:3"></div>
<div style="position:fixed; left:20%; top:10%;z-index:4;">
<img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:500; width:800; ">
</div>
</div>
