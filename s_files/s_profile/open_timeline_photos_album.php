...
error_reporting(1);
	...
	$que_user_info=mysqli_query($con,"select * from users where Email='$user'");
...
<img src="../../s_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $post_img_data[3]; ?>" style="height:500; width:800; ">
</div>
</div>
