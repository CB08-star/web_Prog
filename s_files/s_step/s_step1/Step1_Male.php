...
<?php
	...
	if(isset($_POST['file']) && ($_POST['file']=='Upload'))
	{
		...
		$path2 = "../../../s_users/Male/".$user."/Post/";
		$path3 = "../../../s_users/Male/".$user."/Cover/";
		mkdir($path, 0, true);
		mkdir($path2, 0, true);
		mkdir($path3, 0, true);
...
<head>
    ...
    <LINK REL="SHORTCUT ICON" HREF="../../s_title_icon/Faceback.ico" />
...
<?php
		...
		{
			header("location:../s_step1/Step1_Female.php");
		}
	}
	else
	{
