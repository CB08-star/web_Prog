<?php
	...
	if(isset($_SESSION['suser']))
	{
		...
		{
			$s_txt=$_POST['feedback_txt'];
			$star=$_POST['star'];
			$s_time=$_POST['feedback_time'];
			mysqli_query($con,"insert into feedback(user_id,feedback_txt,star,Date) values($userid,'$s_txt','$star','$s_time')");
		}
		
		if(isset($_POST['delete_feedback']))
		{
			$s_id=intval($_POST['feedback_id']);
			mysqli_query($con,"delete from feedback where feedback_id=$s_id");
		}
...
<?php
	while($feedback_data=mysqli_fetch_array($que_feedback))
	{
		...
		$s_user_id=$feedback_data[1];
		$s_txt=$feedback_data[2];
		$s_star=$feedback_data[3];
		$s_time=$feedback_data[4];
		$que_s_user_info=mysqli_query($con,"select * from users where user_id=$s_user_id");
		$s_user_data=mysqli_fetch_array($que_s_user_info);
		$user_name=$s_user_data[1];
		$user_email=$s_user_data[2];
		$user_gender=$s_user_data[4];
		$que_s_user_pic=mysqli_query($con,"select * from user_profile_pic where user_id=$s_user_id");
		$fetch_user_pic=mysqli_fetch_array($que_s_user_pic);
...
?>
	...
	<tr>
    	<td style="padding-left:25;" rowspan="2"> <img src="../../s_users/<?php echo $user_gender; ?>/<?php echo $user_email; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
        <td colspan="2" style="padding:7;"> <a href="../s_view_profile/view_profile.php?id=<?php echo $s_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#003399;" onMouseOver="feedback_name_underLine(<?php echo $feedback_id; ?>)" onMouseOut="feedback_name_NounderLine(<?php echo $feedback_id; ?>)" id="uname<?php echo $feedback_id; ?>"> <?php echo $user_name; ?> </a>   </td>
       
    </tr>
    <tr>
		<td colspan="2" style=" padding-left:7; "><?php echo $s_txt; ?></td>
        <td> </td>
        <td> </td>
	</tr>
    <tr>
    	<td> </td>
        <td style=" padding-left:7;"> <span style="color:#999999;">  Gave a<?php echo $s_star; ?> star rating</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color:#999999;"> <?php echo $s_time; ?> </span> </td>
        <td> </td>
    </tr>
