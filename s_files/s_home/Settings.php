...
<?php
	if(isset($_POST['change_name']))
	{
		...
		mysqli_query($con,"update users set Name='$Name' where user_id=$userid;");
	...
	if(isset($_POST['change_password']))
	{
		...
		{
			mysqli_query($con,"update users set Password='$new_password' where user_id=$userid;");
		}
		else
		{
...
<div style="position:fixed;  left:63.7%; top:19%; z-index:4">  <input type="button" style="height:22; width:22; background:url(img/exit.png);  border:none;" onClick="hide_name_change_box()"> </div>
...
<div style="position:fixed;  left:63.7%; top:19%; z-index:4">  <input type="button" style="height:22; width:22; background:url(img/exit.png); border:none;" onClick="hide_password_change_box()"> </div>
...
<div style="position:fixed;  left:63.7%; top:19%; z-index:4">  <input type="button" style="height:22; width:22; background:url(img/exit.png); border:none;" onClick="hide_delete_account_box()"> </div>
