...
<?php
	if(isset($_POST['delete_warning']))
	{
		...
		mysqli_query($con,"delete from user_warning where user_id=$user_warning_id;");
	}
	if(isset($_POST['delete_notice']))
	{
		$n_id=intval($_POST['notice_id']);
		mysqli_query("delete from users_notice where notice_id=$n_id;");
	}
	if(isset($_POST['txt']))
	{
		$txt=$_POST['post_txt'];
...
<body id="body" >
<?php
	$que_warning=mysqli_query($con,"select * from user_warning where user_id=$userid");
...
<div style="position:fixed; left:20%; top:32%; color:red; font-size:20px; z-index:3;">  <?php echo $warning_txt; ?> 
</div>
...
<?php
	$que_notice=mysqli_query($con,"select * from users_notice where user_id=$userid");
...
<option value="Private"> Only me </option> 
	...
	<table cellspacing="0">
<?php
	$que_post=mysqli_query($con,"select * from user_post where priority='Public' order by post_id desc");
...
?>
	...
	?>
 	...
 	<tr>
		<td width="5%" style="padding-left:25;" rowspan="2"> <img src="../../s_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
		<td > </td>
		<td> </td>
		<td> </td>
	</tr>
	<tr>
		<td colspan="3" style="padding:7;"> <a href="../s_view_profile/view_profile.php?id=<?php echo $post_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#003399;" onMouseOver="post_name_underLine(<?php echo $postid; ?>)" onMouseOut="post_name_NounderLine(<?php echo $postid; ?>)" id="uname<?php echo $postid; ?>"> <?php echo $user_name; ?> </a>  </td>
		<td> </td>
		<td> </td>
		<td> </td>
	</tr>
...
?>
	<tr>
		...
		<td bgcolor="#EDEFF4" style="padding-left:7;" > <a href="../s_view_profile/view_profile.php?id=<?php echo $comment_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#3B5998;" onMouseOver="Comment_name_underLine(<?php echo $comment_id; ?>)" onMouseOut="Comment_name_NounderLine(<?php echo $comment_id; ?>)" id="cuname<?php echo $comment_id; ?>"> <?php echo $user_name1; ?></a> </td>
	<?php
		if($userid==$post_user_id)
		{ ?>
